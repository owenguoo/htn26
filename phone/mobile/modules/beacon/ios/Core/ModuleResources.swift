...
public enum ModuleResources {
    ...
    public static let bundle: Bundle = {
        ...
        for candidate in [host, .main] {
            if let url = candidate.url(forResource: "BeaconResources", withExtension: "bundle"),
...
public enum PhoneIdentity {
    private static let idKey = "beacon.phoneId"
    private static let nameKey = "beacon.name"
    private static let hubKey = "beacon.lastHubURL"
