...
Pod::Spec.new do |s|
  # Not 'Beacon': that is the app target's module name, and a pod that shares
  # it makes `import Beacon` inside the app resolve to the app itself — the
  # module class then silently disappears from Release builds.
  s.name           = 'BeaconNative'
  s.version        = '1.0.0'
  s.summary        = 'Native Beacon client: ARKit pose source, frame encoder, operator view.'
  ...
  s.resource_bundles = {
    'BeaconResources' => ['Resources/**/*.{png,json}']
  }
end
