...
from beacon.matching import Embedder, normalize_embedding, rank_candidates, select_reference
from beacon.schemas import Identifier
from beacon.worker import Frame
