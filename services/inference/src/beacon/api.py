...
from beacon.demo import add_demo_routes, authenticate_demo
from beacon.images import decode_image
from beacon.matching import Embedder
from beacon.person_api import IMAGE_BODY, add_person_routes
from beacon.schemas import BackendName, Detector, Query, Result
...
def create_app(
    ...
    app = FastAPI(title="Beacon Inference", version="0.1.0", lifespan=lifespan)
