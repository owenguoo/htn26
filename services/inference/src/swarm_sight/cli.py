...
from swarm_sight.images import annotate, decode_image
from swarm_sight.schemas import Query
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Swarm Sight cloud GPU inference")
    ...
    from swarm_sight import match_cli
